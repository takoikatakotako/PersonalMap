...
struct AddMapPolylineObjectView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button {
                // PolyLine
                let polyLine: MapPolyLine = MapPolyLine(id: UUID(), mapObjectType: .polyLine, imageName: "star.circle", isHidden: false, objectName: objectName, coordinates: coordinates, items: [])
